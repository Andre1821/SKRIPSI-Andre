 ...
 */
public class MessageStatsReportModLatency extends Report implements MessageListener {
     ...
     * Constructor.
     */
    public MessageStatsReportModLatency() {
        init();
    }
    ...
    public void messageTransferred(Message m, DTNHost from, DTNHost to,
        ...
        this.nrofRelayed++;
//        if (m.getId().contains("S")) { //optional jika ingin mengambil pesan sudden saja
            if (nrofMsgForward.containsKey(m.getId())) {
